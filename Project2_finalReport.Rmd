...
Let us use the fit_int2 model and conduct stwpwise regression:
...
The BIC criterion removes all interaction effects and removes entropy from the model. The residual deviance of this model is the same as the non-interacted model of 53.299 (since the resultant model is the same).
