...
The trendline in the residual v/s fitted plot shows little to no deviation from the horizontal zero line showing that the distribution of the residuals is not concerening. Further, there do appear to be a few points with relatively higher outliers; however, they are not greater than 3 so it is not concerning.
...
EXPLAIN
Look at class video describing code 10.48 to describe this plot
...
EXPLAIN
All, except entropy, are greater than 5. clear multicollinearity.
