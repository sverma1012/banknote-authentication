...
```{r}
conf_int = predict(fit_int2_aic, interval = "confidence")
conf_int2 = as.data.frame(conf_int)
sort_aic = order(as.data.frame(conf_int))
sort_aic[c(40,100,500,700, 850,990),]
```
